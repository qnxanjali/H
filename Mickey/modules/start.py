...
async def start(_, m: Message):
    if m.chat.type == ChatType.PRIVATE:
        ...
        await accha.edit("__ᴡᴇʟᴄᴏᴍᴇ ʙᴀʙʏ ꨄ︎ ᴡᴀɪᴛ..🥵__")
        await asyncio.sleep(0.2)
        await accha.edit("__ʜᴇʏ ʙᴀʙʏ ꨄ ʜᴏᴡ ᴀʀᴇ ʏᴏᴜ⚡.....__")
        await asyncio.sleep(0.2)
        await accha.edit("__ʙᴏᴛ sᴛᴀʀᴛɪɴɢ ꨄ︎ ʙᴀʙʏ📍..__")
        await asyncio.sleep(0.2)
        await accha.delete()
        ...
        await m.reply_photo(
            ...
            caption=f"""**🥀💨ɢʀᴏᴜᴘ ᴊᴏɪɴ ᴋʀ ʟᴏ 🌷°‌⁪༎꯭ࠫ𝆺𝅥•๋⸙‌ٖٖٖٖٖٖٜٖٖ [⚡ᴊᴏɪɴ⚡](https://t.me/ANJALIWORLD) 🍷
 🍷💨ᴍʏ ᴄᴜᴛᴇ ᴏᴡɴᴇʀ🍒🥀 [ᴍᴀʜᴛᴏ ✯ ᴀɴᴊᴀʟɪ ](https://t.me/AnjaliOwnerBot) """,
